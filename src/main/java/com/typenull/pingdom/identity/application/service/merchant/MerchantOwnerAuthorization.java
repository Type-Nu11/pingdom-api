...
/**
 * 메서드 보안 표현식에서 사업자 승인 상태와 검증 완료 상태를 구분해 확인.
 * isApproved는 회원 역할·탈퇴·프로필을, isActive는 여기에 본인·사업자 검증 승인까지 확인.
 */
...
public class MerchantOwnerAuthorization {
    ...
    /**
     * 메서드 보안에서 JWT 주체의 점주 역할·미탈퇴 상태·ACTIVE 프로필과 본인·사업자 검증 승인을 모두 확인.
     * 주체가 없거나 조건을 충족하지 않으면 false를 반환하며 현재 정지 여부는 이 판정의 조건에서 제외.
     */
