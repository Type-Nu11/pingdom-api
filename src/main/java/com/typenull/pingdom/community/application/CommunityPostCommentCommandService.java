...
/**
 * 숨김 처리되지 않은 게시글에 댓글을 저장.
 * 작성자 식별자는 인증 경계에서 전달받고, 본문의 공백 제거 외 길이·필수 값 검증은 요청 DTO가 담당.
 */
@Service
...
public class CommunityPostCommentCommandService {
    ...
    /**
     * 숨김되지 않은 게시글에 인증 경계에서 받은 작성자 ID로 댓글을 저장하고 댓글·게시글 ID와 정리된 본문을 반환.
     * 숨김 또는 없는 게시글은 POST_NOT_FOUND로 거절.
     */
    @Transactional
