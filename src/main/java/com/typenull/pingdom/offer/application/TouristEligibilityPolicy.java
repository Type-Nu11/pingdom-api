...
/**
 * 탈퇴·정지되지 않은 일반 사용자에게 쿠폰 발급을 허용하는 자격 정책입니다.
 * PUBLIC은 여행 일정 조건만 생략하고, 기본 정책은 오늘을 양 끝 포함하는 SCHEDULED 일정을 요구합니다.
 */
@Component
...
public class TouristEligibilityPolicy {
    ...
    /**
     * 탈퇴·정지되지 않은 일반 사용자에게 정책에 따른 쿠폰 발급 자격이 있는지 확인합니다.
     * PUBLIC은 여행 일정 조건을 생략하고 그 외에는 오늘을 포함하는 SCHEDULED 일정이 필요하며 미충족 시 관광객 자격 오류를 던집니다.
     */
