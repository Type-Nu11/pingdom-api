...
/**
 * 현재 장소 소유 점주의 티켓·클래스 상품을 생성·조회하고 활성 상태를 변경.
 * 상태 변경은 상품 행을 잠근 뒤 현재 장소 소유권을 검사하며, 기존 예약과 슬롯 상태는 직접 변경 대상에서 제외.
 */
@Service
...
public class ReservableProductService {
    ...
    /**
     * 현재 점주의 장소 소유권을 확인해 요청 상품 유형·이름으로 예약 가능 상품을 저장하고 응답을 반환.
     * 도메인 입력 조건 위반은 가용 상품 입력 오류로 변환하며 슬롯과 예약은 생성 대상에서 제외.
     */
    @Transactional
