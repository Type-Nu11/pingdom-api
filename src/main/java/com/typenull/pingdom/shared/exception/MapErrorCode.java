...
public enum MapErrorCode implements ErrorCode {
    ...
    PLACE_REVIEW_MEDIA_NOT_FOUND(HttpStatus.NOT_FOUND, "리뷰 사진을 찾을 수 없습니다."),
    PLACE_REVIEW_MEDIA_FORBIDDEN(HttpStatus.FORBIDDEN, "다른 사용자의 리뷰 사진은 연결하거나 삭제할 수 없습니다."),
    PLACE_REVIEW_MEDIA_INVALID_REQUEST(HttpStatus.BAD_REQUEST, "리뷰 사진 요청이 올바르지 않습니다."),
    PLACE_REVIEW_MEDIA_EXPIRED(HttpStatus.CONFLICT, "리뷰 사진 연결 가능 시간이 만료되었습니다."),
    PLACE_REVIEW_MEDIA_ALREADY_CONNECTED(HttpStatus.CONFLICT, "이미 다른 리뷰에 연결된 사진입니다."),
    PLACE_REVIEW_MEDIA_FILE_TOO_LARGE(HttpStatus.PAYLOAD_TOO_LARGE, "리뷰 사진은 10MB 이하여야 합니다."),
    PLACE_REVIEW_MEDIA_UNSUPPORTED_TYPE(HttpStatus.UNSUPPORTED_MEDIA_TYPE, "리뷰 사진은 JPEG 또는 PNG 형식만 지원합니다."),
    PLACE_REVIEW_MEDIA_STORAGE_UNAVAILABLE(HttpStatus.SERVICE_UNAVAILABLE, "리뷰 사진 저장소를 사용할 수 없습니다."),
    ...
    LOCAL_HOT_QUERY_CONDITION_INVALID(HttpStatus.BAD_REQUEST, "지역 핫플 조회 조건이 올바르지 않습니다."),
    ...
    NAVER_ADDRESS_SEARCH_UNAVAILABLE(HttpStatus.SERVICE_UNAVAILABLE, "네이버 주소 검색 서비스를 사용할 수 없습니다."),
    NAVER_ADDRESS_SEARCH_TIMEOUT(HttpStatus.GATEWAY_TIMEOUT, "네이버 주소 검색 응답 시간이 초과되었습니다."),
    NAVER_ADDRESS_SEARCH_RATE_LIMITED(HttpStatus.TOO_MANY_REQUESTS, "네이버 주소 검색 호출 한도를 초과했습니다."),
    NAVER_ADDRESS_SEARCH_FAILED(HttpStatus.BAD_GATEWAY, "네이버 주소 검색 호출에 실패했습니다."),
