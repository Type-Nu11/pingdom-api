package com.typenull.pingdom.shared.api;
...
public class HomeController {
                                    ...
                                    value = """
                                            {
                                              ...
                                              "availableEndpoints": ["/auth/signup", "/auth/login", "/auth/email/resend", "/auth/email/verify", "/auth/token/refresh", "/auth/logout", "/users/me"],
    ...
    public Map<String, Object> home() {
        return Map.of(
                "message", "Pingdom Backend is running.",
                "availableEndpoints", new String[]{"/auth/signup", "/auth/login", "/auth/email/resend", "/auth/email/verify", "/auth/token/refresh", "/auth/logout", "/users/me"},
