...
public record PlaceReviewResponse(Long reviewId, Long placeId, Long userId, String recommendReason, String content, List<String> imageUrls, LocalDateTime createdAt) {
 public static PlaceReviewResponse from(PlaceReview r){return new PlaceReviewResponse(r.getId(),r.getPlace().getId(),r.getUserId(),r.getRecommendReason(),r.getContent(),r.getImageUrls(),r.getCreatedAt());}}
