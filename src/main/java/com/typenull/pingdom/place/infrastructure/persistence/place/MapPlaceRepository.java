...
public interface MapPlaceRepository extends JpaRepository<MapPlace, Long> {
    ...
    @Query("""
            ...
            """)
    // 탈퇴한 사용자가 등록한 장소의 표시 등록자명을 일괄 변경.
    ...
    // 커뮤니티 유입 조회수는 읽기-수정-쓰기 경쟁 없이 DB에서 원자적으로 증가시킴.
