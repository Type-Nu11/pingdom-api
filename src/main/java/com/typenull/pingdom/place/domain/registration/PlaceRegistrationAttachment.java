...
/**
 * 신청 첨부의 private 객체 키, 바이트 크기, SHA-256 해시와 표시·보존 정보를 보관합니다.
 * 키의 상대 경로 형식과 메타데이터를 검증하며 실제 객체 내용 검사는 업로드 서비스가 맡습니다.
 * 보존 기한 null은 기한 없음이고, 기한과 현재 시각이 같으면 이미 만료된 것으로 봅니다.
 */
@Getter
@Entity
