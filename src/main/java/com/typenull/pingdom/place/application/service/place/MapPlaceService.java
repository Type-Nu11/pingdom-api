...
/**
 * 장소 소유 매핑을 확인한 뒤 장소·북마크·추세 이력·추천 스냅샷 삭제를 조정합니다.
 * 장소 등록자 ID와 현재 사업자 소유 매핑은 별개이므로 삭제 권한은 후자를 기준으로 판단합니다.
 */
@Service
...
public class MapPlaceService {
    ...
    /**
     * 현재 Merchant 소유 연결이 확인된 장소의 북마크 추세·북마크·장소·추천 스냅샷을 삭제합니다.
     * 장소 부재나 소유권 불일치는 거절하며, 이 메서드에서 정리하지 않는 다른 참조의 FK 제약은 삭제를 실패시킬 수 있습니다.
     * 장소 및 소유 연결을 별도로 잠그는 경로는 아닙니다.
     */
    @Transactional
