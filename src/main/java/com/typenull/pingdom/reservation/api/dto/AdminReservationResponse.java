...
public record AdminReservationResponse(Long id, ReservationStatus status, int quantity, Long touristUserId,
        ...
        Long productId, String productName, LocalDateTime createdAt, LocalDateTime confirmedAt, Long reviewedBy,
    ...
    public static AdminReservationResponse of(Reservation reservation, String touristUsername, Long ownerId,
            String ownerUsername, Long placeId, String placeName, LocalDateTime startsAt, LocalDateTime endsAt,
            String productName, List<AdminReservationStatusHistoryResponse> history) {
        return new AdminReservationResponse(reservation.getId(), reservation.getStatus(), reservation.getQuantity(),
                ...
                reservation.getAvailabilityId(), startsAt, endsAt, reservation.getProductId(), productName,
