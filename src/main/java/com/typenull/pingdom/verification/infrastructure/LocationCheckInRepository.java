...
public interface LocationCheckInRepository extends JpaRepository<LocationCheckIn, Long> {
    ...
    /** ID가 존재해도 사용자 ID가 다르면 빈 결과로 반환해 소유권 확인에 사용. */
