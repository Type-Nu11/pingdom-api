...
public interface VisitVerificationSessionRepository extends JpaRepository<VisitVerificationSession, Long> {
    ...
    /** foreground 장소 탐색 전 당일 지정 상태의 세션을 마지막 서버 확인 시각 역순으로 반환한다. */
    ...
    /** 소유자 조건으로 세션을 조회하면서 쓰기 잠금을 잡는다. 트랜잭션 안에서 관측/만료 갱신에 사용한다. */
    ...
    /** 상태와 무관하게 세션 만료 시각이 기준 이하인 행을 삭제하고 삭제 건수를 반환한다. */
