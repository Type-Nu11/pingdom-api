...
/**
 * 근접 체크인의 반경·관측 정확도는 미터 단위.
 * 기본값은 반경 100m, 정확도 50m, 관측 TTL 5분, 미래 시각 허용 30초.
 * 반경 상한 1,000m는 설정 바인딩의 Bean Validation에서 검사.
 */
@Validated
...
public record LocationCheckInProperties(
    ...
    /** 누락값을 기본값으로 채우며 관측 TTL은 양수, 미래 허용 오차는 0 이상이어야 함. */
