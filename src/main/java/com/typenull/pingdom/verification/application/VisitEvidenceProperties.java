...
/**
 * 증빙 보관 및 정리 배치 설정이다.
 * retention 기본값은 30일, maxFileSizeBytes는 10MiB이며 업로드 입력과 재인코딩 결과 모두에 적용한다.
 * 정리는 기본 10건씩 최대 10회이며 배치 크기 상한 10은 Bean Validation에서 적용한다.
 */
@Validated
...
public record VisitEvidenceProperties(Duration retention, @Min(1) Long maxFileSizeBytes,
    ...
    /** 누락된 설정을 기본값으로 채우고 양수가 아닌 보관 기간을 즉시 거부한다. */
