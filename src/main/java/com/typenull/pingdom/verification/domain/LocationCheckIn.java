...
/**
 * 관광객의 장소 체크인 기록으로 관측 시각과 서버 기록 시각을 구분한다.
 * 근접 일치와 체류 인증 완료 상태를 보관하며, 유효한 위치·기간인지의 판정은 생성 전 서비스에서 수행한다.
 */
@Entity
@Getter
...
public class LocationCheckIn {
    ...
    /** 근접 반경 판정을 통과한 체크인을 만든다. 체류 인증까지 완료했다는 의미는 아니다. */
    ...
    /** 체류 인증 세션을 완료한 결과를 DWELL_VERIFIED 체크인으로 기록한다. */
    ...
    /** 사용자·장소·날짜·시각의 null을 거부하고 호출자가 확정한 거리(미터)와 상태를 보관한다. */
