...
class NearbyReservablePlaceOpenApiContractTest {
    ...
    /** app 명세의 인증, 필수 좌표, 정렬 enum, 페이지 필수 필드와 nullable 상품 필드 계약을 확인. */
    @Test
    ...
    /** 이름이 같은 operation 파라미터를 찾고 없으면 missing node를 반환해 후속 assertion에서 실패하게 함. */
    ...
    /** JSON 배열의 문자열 값을 순서대로 수집해 enum과 필수 필드 집합을 비교. */
    ...
    /** app OpenAPI를 HTTP로 조회해 200 응답을 확인하고 UTF-8 JSON으로 파싱. */
