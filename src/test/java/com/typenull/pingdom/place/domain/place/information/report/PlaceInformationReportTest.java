...
class PlaceInformationReportTest {
    ...
    /** 제보 입력 공백을 정리하고 승인 메타데이터를 기록한 뒤 반박 제출 시 원 제보와 반박 상태·연결이 함께 반영되는지 확인한다. */
    @Test
    ...
    /** 반려 사유 공백을 거부하고 반려 후 재심사 시작과 반박 제출을 막는지 확인한다. */
    @Test
    ...
    /** 반박 승인에 사유가 필요하고 승인 후 반려로 다시 처리할 수 없는지 확인한다. */
    @Test
    ...
    /** 제보·반박 흐름에서 공통으로 사용할 소유자 1번의 장소를 만든다. */
