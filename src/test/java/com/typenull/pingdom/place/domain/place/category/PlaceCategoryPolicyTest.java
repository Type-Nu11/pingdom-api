...
class PlaceCategoryPolicyTest {
    ...
    /** 정규 카테고리 코드·한국어 표시명과 enum 집합이 일치해 응답 분류 계약을 유지하는지 확인. */
    @Test
    ...
    /** 문화재의 한국어·영어·공백 포함 별칭을 정규 코드로 변환하고 알려진 별칭 집합을 제공하는지 확인. */
    @Test
    ...
    /** 지원하지 않는 기존 문자열은 정규 코드 null·응답 미분류로 표시하되 저장 정규화에서는 OTHER로 처리하는지 확인. */
    @Test
