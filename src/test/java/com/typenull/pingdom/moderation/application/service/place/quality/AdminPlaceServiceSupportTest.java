...
/** 장소 서비스 공통 변환 함수의 기본 계약을 고정하는 단위 테스트. */
class AdminPlaceServiceSupportTest {

    /**
     * 문자열 양끝 공백은 제거하고 공백뿐인 값은 null로 정규화하는지 검증.
     */
    @Test
    ...
    /**
     * 관광 카테고리 입력이 null이면 빈 목록으로 정규화하는지 검증.
     */
    @Test
    ...
    /**
     * 위도·경도를 Point로 변환할 때 X는 경도, Y는 위도이며 SRID가 WGS84의 4326인지 검증.
     */
    @Test
