...
public final class VerificationSecurityFixture {
    ...
    /** 정적 fixture 생성 함수만 사용하도록 인스턴스 생성을 막는다. */
    private VerificationSecurityFixture() {
    }

    /** 이름과 역할을 지정한 미영속 사용자를 만든다. 저장과 토큰 발급은 호출 테스트가 담당한다. */
    ...
    /** 고정 서울 시청 좌표와 지정 등록자 ID를 가진 장소를 만든다. */
    ...
    /** 서울 날짜와 현재 시각 10초 전 관측으로 거리 3.5m의 근접 체크인을 만든다. */
    ...
    /** ImageIO로 유효한 2×2 RGB JPEG 바이트를 메모리에서 생성한다. */
