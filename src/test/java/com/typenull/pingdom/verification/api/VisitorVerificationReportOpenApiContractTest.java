...
class VisitorVerificationReportOpenApiContractTest {
    ...
    /**
     * 작성자 제보·정정 경로가 app에 있고 admin에는 없는지 확인.
     * 성공/오류 schema와 예시, JWT 선언 및 응답 required/nullable 계약을 검사.
     */
    @Test
    ...
    /** 성공 응답이 지정한 components schema를 참조하는지 확인. */
    ...
    /** validation 오류 응답의 schema와 예시 코드를 함께 대조. */
    ...
    /** 같은 HTTP 응답에서 validation·도메인 오류가 oneOf로 표현되고 각 예시가 존재하는지 확인. */
    ...
    /** required 필드 목록이 정확히 일치하고 지정된 필드들이 null을 허용하는지 확인. */
