...
class OutboxEventTest {
    ...
    /**
     * 첫 실패에서 RETRY·시도 1회·지정 재시도 시각·오류 메시지가 기록되는지 검증.
     */
    @Test
    ...
    /**
     * 실패와 재선점을 5회 반복하면 FAILED 상태·시도 수 5·마지막 오류를 유지하는지 검증.
     */
    @Test
    ...
    /**
     * 성공을 두 번 기록해도 SUCCEEDED 상태와 최초 처리 완료 시각이 유지되는지 검증.
     */
    @Test
    ...
    /**
     * 선점 이벤트를 stale 복구하면 RETRY·시도 증가·재시도 시각을 반영하고 processingStartedAt을 제거하는지 검증.
     */
    @Test
    ...
    /**
     * 현재보다 1분 전에 생성된 이메일 인증 이벤트를 1초 전에 선점한 상태로 제공.
     */
