...
/**
 * 기존 데이터 이관 시 보존·변환·거절해야 할 상태를 migration 버전과 함께 기술.
 */
public final class FlywayBackfillFixtures {

    /**
     * 버전별 기존 데이터 이관 기대값의 정적 제공을 위한 유틸리티 생성자. 마이그레이션 실행 상태를 보관하는 인스턴스 생성 차단.
     */
    private FlywayBackfillFixtures() {
    }

    /**
     * 기존 이미지·소유권·출처 기본값의 정상·경계·실패·재시도 backfill 기대값을 제공. SQL 실행은 통합 테스트가 담당.
     */
